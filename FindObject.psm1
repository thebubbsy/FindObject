function Find-ObjectByName {
    ...
    begin {
        ...
        $FinderPatterns = @($keywords | ForEach-Object { "*$_*" })
        $FinderLogic = $logic
    ...
    process {
        ...
        if ($null -eq $objectName) {
            Write-Verbose "Input object missing or null 'Name' property. Skipping."
        ...
        if ($FinderLogic -eq 'OR') {
            # OR Logic: Early return and output on match
            ...
            # AND Logic: Early return on mismatch
