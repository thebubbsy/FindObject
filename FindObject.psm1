function Find-ObjectByName {
    ...
    begin {
        ...
        # Pre-calculate wildcard patterns and array length for faster processing
        $FinderKeywordCount = $FinderKeywords.Count
        $FinderPatterns = [string[]]::new($FinderKeywordCount)
    ...
    process {
        ...
        if ($null -eq $objectName) {
            # Evaluating type in string interpolation is slow, avoid it here
        ...
        # -isnot and cast is faster than .ToString()
