function Find-ObjectByName {
    ...
    begin {
        ...
        # ⚡ Bolt Optimization: Pre-calculate wildcard patterns to avoid string interpolation ("*$keyword*") inside the process block loop.
    ...
    process {
        ...
        if ($FinderLogic -eq 'OR') {
            ...
            # ⚡ Bolt Optimization: Use standard for loop with cached length instead of foreach for faster iteration.
